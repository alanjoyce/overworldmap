...
The original _Final Fantasy_ takes what we would now consider to be an extremely basic approach to in-game cartography. There is a traversable overworld (seen in __1__), which includes abstracted representations of towns and other landmarks.

For a wider view of the world, a broom in [Matoya's Cave](http://finalfantasy.wikia.com/wiki/Matoya's_Cave) (__2__) teaches the player a "magic spell" consisting of pressing B and SELECT simultaneously. This brings up a true world map (__3__), which indicates the player's current location and gives them a sense for the geography of the playable area.
...
Without any spells or items, players see the overworld as shown in __1__ above. However, once the player acquires a hovercraft, their view of the world expands to that seen in __2__. This view takes advantage of the [Mode 7](http://en.wikipedia.org/wiki/Mode_7) graphical feature of the SNES to scale the background world texture such that it tapers off toward the top of the screen and creates the impression of a 3D environment.

To get an even broader view of the world, the player can use Sight (see __3__) or Gnomish Bread. The resulting map (seen in __4__) is simply a zoomed-out view of the nearby overworld.
...
The basic overworld view (shown in __1__ and __2__) is similar to that seen in previous games, but a new minimap has been added in the bottom-right corner. This minimap proves useful when flying quickly over the world (see __4__), but it also consumes valuable screen real estate and can sometimes feel more obligatory than elegant.
